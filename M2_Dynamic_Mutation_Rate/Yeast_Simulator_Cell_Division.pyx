    ...
    for i in xrange(n_BN):
        ...
        while tp < dps: 
            ...
            for h in xrange(n_cells):
                    ...
                    # Decide on mutation rate
                    mutation_rate_temp = decide_mutation_rate(mutation_rate,genotypes[k][1])
...
cdef calculate_freq(CH,N_BN,N_CH,PM,MID_Hap,N,n_mut):
    ...
    return 0
cdef bring_random_number():
    import random
    N = random.randrange(800,830)
